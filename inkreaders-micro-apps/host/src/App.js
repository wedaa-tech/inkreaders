...
const App = () => {
  return (
    <div className="text-center">
      ...
      {/* Navigation Links - Now includes external links */}
      <nav className="mb-8 p-4 bg-blue-600 rounded-lg shadow-md flex justify-center space-x-6">
        {/* Link to Hugo Home */}
        <a href="https://inkreaders.com/" className="text-white text-lg font-semibold hover:text-blue-200 transition duration-200">
          Home
        </a>
        {/* Link to Hugo Blogs */}
        <a href="https://inkreaders.com/posts/" className="text-white text-lg font-semibold hover:text-blue-200 transition duration-200">
          Blogs
        </a>
        {/* Internal React App Links */}
        ...
        {/* Link to Docusaurus Docs */}
        <a href="https://inkreaders.com/docs/" className="text-white text-lg font-semibold hover:text-blue-200 transition duration-200">
          Docs
        </a>
      </nav>
